...
title(xlab = "c", cex.lab = 2,cex.axis = 1.8,  font.lab = 3)
...
# }
par(mar=c(4,5,2.5,1),mgp=c(3,1,0))
plot(abs(ds-whole), ylim = c(0,2.5),lty = 3, pch=15, type = 'o',col="blue",xaxt = "n",yaxt = "n", xlab = "c", ylab = "absolute difference", cex = 2,lwd = 5,font.lab = 3,cex.lab = 1.5)
axis(1, at = 1:6, labels = as.character(hc_seq),cex.axis = 1.8)
axis(2, at = c(0.0,0.5,1,1.5,2,2.5), labels = c("0.0","0.5","1.0","1.5","2.0","2.5"),cex.axis = 1.8)
# showtext_auto(enable = TRUE)
# font_add("CENTURY", "CENTURY.ttf")
# plot(ds_rmse, ylim = c(0,max(ds_rmse)),lty = 1, pch=1, type = 'o',cex = 1,xaxt = "n",yaxt = "n",xlab = "", ylab = "")
abline(h = abs(ds-whole), lwd = 5, lty = 3, col = "red")
...
plot(rep(z[1], 6), type = "l", lty = 3, col = "red", ylim = c(0, 0.35), xaxt = "n", xlab = "L", ylab = "absolute difference", 
     cex = 2,lwd = 5,font.lab = 3,cex.lab = 1.5,cex.axis = 1.8)
axis(1, at = 1:6, labels = L_seq,cex.axis = 1.8)
...
# }
par(mar=c(4,5,2.5,1),mgp=c(3,1,0))
plot(abs(ds-as.vector(all)), ylim = c(0,2.5),lty = 3, pch=15, type = 'o',col="blue",xaxt = "n",yaxt = "n", xlab = "c",  ylab = "absolute difference", cex = 2,lwd = 5,font.lab = 3,cex.lab = 1.5)
axis(1, at = 1:6, labels = as.character(kc_seq),cex.axis = 1.8)
axis(2, at = c(0.0,0.5,1,1.5,2,2.5), labels = c("0.0","0.5","1.0","1.5","2.0","2.5"),cex.axis = 1.8)
# showtext_auto(enable = TRUE)
# font_add("CENTURY", "CENTURY.ttf")
# plot(ds_rmse, ylim = c(0,max(ds_rmse)),lty = 1, pch=1, type = 'o',cex = 1,xaxt = "n",yaxt = "n",xlab = "", ylab = "")
abline(h = abs(ds-as.vector(all)), lwd = 5, lty = 3, col = "red")
